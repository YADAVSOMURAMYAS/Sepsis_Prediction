...
export default function AddPatientModal({ open, onClose }: Props) {
  ...
  function Field({ label, k, type = 'number', min, max, step }:
    { label: string; k: string; type?: string; min?: number; max?: number; step?: number }) {
    return (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className={styles.body}>
              ...
              <div className={styles.grid3}>
                <Field label="Full Name" k="name" type="text" />
                <Field label="Age" k="age" min={0} max={120} />
                <div className={styles.field}>
              ...
              <div className={styles.grid2}>
                ...
                <Field label="Diagnosis" k="diagnosis" type="text" />
              </div>

              {/* Vitals */}
              <div className={styles.section}>Initial Vitals</div>
              <div className={styles.grid4}>
                <Field label="Heart Rate (bpm)"  k="hr"      min={20}  max={300} />
